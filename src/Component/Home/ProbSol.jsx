...
{CardData.map((card, index) => (
  <div key={index} className="col-span-12 cursor-pointer sm:col-span-6 md:col-span-4 lg:col-span-3 border hover:bg-primary hover:text-white border-accent/10 shadow-xl shadow-primary/10 h-[349px] rounded-[20px] p-5 space-y-5 flex flex-col  ">
    ...
    <h2 className="font-bold xl:text-lg tr">{card.title}</h2>
